...
public class QueryEnhancerFactory {
  ...
  private static final boolean jSqlParserPresent = ClassUtils.isPresent("net.sf.jsqlparser.parser.JSqlParser",
      org.springframework.data.jpa.repository.query.QueryEnhancerFactory.class.getClassLoader());
  ...
  /**
   * Creates a new {@link QueryEnhancer} for the given {@link org.springframework.data.jpa.repository.query.DeclaredQuery}.
   *
