...
public class QueryUtils {
  ...
  static String createCountQueryFor(String originalQuery, @Nullable String countProjection, boolean nativeQuery) {
    ...
    if (countProjection == null) {
      ...
      if (variable != null && (nativeQuery && (variable.contains(",") || "*".equals(variable)))) {
        ...
        String alias = org.springframework.data.jpa.repository.query.QueryUtils.detectAlias(originalQuery);
  ...
  /**
   * Creates a criteria API {@link jakarta.persistence.criteria.Order} from the given {@link Sort.Order}.
   *
