...
public enum ReactiveJpaQueryFactory {
  ...
  AbstractReactiveJpaQuery fromMethodWithQueryString(ReactiveJpaQueryMethod method, Mutiny.SessionFactory sessionFactory, String queryString,
    ...
    return method.isNativeQuery()
        ? new NativeReactiveJpaQuery(method, sessionFactory, queryString, countQueryString, queryRewriter, evaluationContextProvider,
        PARSER)
        : new SimpleReactiveJpaQuery(method, sessionFactory, queryString, countQueryString, queryRewriter, evaluationContextProvider,
        PARSER);
  }
