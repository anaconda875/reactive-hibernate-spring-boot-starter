...
public class ReactiveJpaQueryExecutionConverters {
  ...
  private static final Map<Class<?>, QueryExecutionConverters.ExecutionAdapter> EXECUTION_ADAPTER = new HashMap<>();
...
//    }
  ...
  static class ReactiveFlatteningConverter implements GenericConverter {
    ...
    public Set<ConvertiblePair> getConvertibleTypes() {
      return Set.of(/*new ConvertiblePair(Mono.class, Mono.class), */new ConvertiblePair(Flux.class, Flux.class),
          /*new ConvertiblePair(Uni.class, Uni.class), */new ConvertiblePair(Multi.class, Multi.class));
    }

    @Override
    public Object convert(Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
      if(source instanceof Flux<?> flux) {
        return flux.flatMap(o -> {
