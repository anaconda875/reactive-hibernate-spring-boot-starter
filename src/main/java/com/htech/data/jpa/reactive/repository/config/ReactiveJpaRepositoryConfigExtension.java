...
public class ReactiveJpaRepositoryConfigExtension extends RepositoryConfigurationExtensionSupport {
  ...
  public void registerBeansForRoot(
    ...
    //    registerLazyIfNotAlreadyRegistered(() -> new RootBeanDefinition(PAB_POST_PROCESSOR),
    // registry,
    ...
    registerIfNotAlreadyRegistered(
        () -> new RootBeanDefinition(JPA_METAMODEL_CACHE_CLEANUP_CLASSNAME),
        registry,
    ...
    registerIfNotAlreadyRegistered(
        () -> {
          Object value =
              AnnotationRepositoryConfigurationSource.class.isInstance(config) //
          ...
          BeanDefinitionBuilder builder =
              BeanDefinitionBuilder.rootBeanDefinition(JpaEvaluationContextExtension.class);
          builder.addConstructorArgValue(value);

          return builder.getBeanDefinition();
        },
        registry,
        JpaEvaluationContextExtension.class.getName(),
        source);
  }
