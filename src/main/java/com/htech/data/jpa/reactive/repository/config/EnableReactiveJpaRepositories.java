...
public @interface EnableReactiveJpaRepositories {
  ...
  /**
   * Configures the name of the {@link Mutiny.SessionFactory} bean definition to be used to create
  ...
  /**
   * Configures the name of the {@link ReactiveJpaEntityOperations} bean definition to be used to
   * create repositories discovered through this annotation. Defaults to {@code
   * reactiveJpaEntityTemplate}.
   *
   * @return
   */
